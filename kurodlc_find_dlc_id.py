...
if __name__ == "__main__":
    ...
    id_lower_limit, id_upper_limit = 0, 250
    ...
    if len(available_ids) > 10:
        print("The next 10 available id numbers are {0}".format(available_ids[0:10]))
    else:
        print("The next {0} available id numbers are {1}".format(len(available_ids), available_ids))
    while 1:
