...
def extract_original_tbls_from_p3a (original_p3a_filename):
    ...
    if os.path.exists(original_p3a_filename):
        with open(original_p3a_filename,'rb') as p3a.f:
            ...
            files_to_extract = ['t_costume.tbl', 't_dlc.tbl', 't_item.tbl', 't_recipe.tbl', 't_shop.tbl',
                't_shop_normal.tbl', 't_skill.tbl', 't_viewer.tbl', 't_voice.tbl', 't_name.tbl']
            filenames = ['t_costume.tbl.original', 't_dlc.tbl.original', 't_item.tbl.original',
                't_recipe.tbl.original', 't_shop.tbl.original', 't_shop_normal.tbl.original',
                't_skill.tbl.original', 't_viewer.tbl.original', 't_voice.tbl.original', 't_name.tbl']
            entries_to_extract = []
